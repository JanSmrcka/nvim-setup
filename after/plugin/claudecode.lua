...
safe_map({ "n", "x" }, "<leader>cc", "<cmd>ClaudeCode<cr>", { desc = "Claude: Toggle" })
safe_map({ "n", "x" }, "<leader>cf", "<cmd>ClaudeCodeFocus<cr>", { desc = "Claude: Focus" })
safe_map("v", "<leader>cs", "<cmd>ClaudeCodeSend<cr>", { desc = "Claude: Send selection" })
safe_map("n", "<leader>cb", "<cmd>ClaudeCodeAdd %<cr>", { desc = "Claude: Add buffer" })
safe_map("n", "<leader>ca", "<cmd>ClaudeCodeDiffAccept<cr>", { desc = "Claude: Accept diff" })
safe_map("n", "<leader>cd", "<cmd>ClaudeCodeDiffDeny<cr>", { desc = "Claude: Deny diff" })
safe_map("n", "<leader>cm", "<cmd>ClaudeCodeSelectModel<cr>", { desc = "Claude: Select model" })
